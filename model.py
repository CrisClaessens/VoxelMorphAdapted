...
class RegistrationModel(LoadableModel):
    """
    ...
    def __init__(self,
        ...
        Parameters:
            ...
            post_img_feats: Number of post-operative image features. Default is 1.
            post_mask_feats: Number of post-operative mask features. Default is 1.
            intra_mask_feats: Number of intra-operative mask features. Default is 1.
        ...
        self.unet_model = Unet(
            inshape,
            infeats=(post_img_feats + post_mask_feats + intra_mask_feats),
    ...
    def forward(self, image, post_mask, intra_mask, registration=False):
        '''
        Parameters:
            image: Post-operative MRI image tensor.
            post_mask: Mask of resection cavity tensor resulting from segmentation of post-operative MRI image.
            intra_mask: Mask of resection cavity tensor resulting from segmentation of intra-operative point cloud.
            registration: Return transformed image and flow. Default is False.
        '''

        # concatenate inputs and propagate unet
        x = torch.cat([image, post_mask, intra_mask], dim=1)
        x = self.unet_model(x)
        ...
        y_source = self.transformer(image, pos_flow)
